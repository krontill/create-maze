---
name: explain
description: Produce a structured walkthrough of unfamiliar code. Use when onboarding to a codebase, reading code written by others, or trying to understand what a module/function/file does before modifying it.
...
1. Read the target code. Ask the user to specify it if not clear from context.
