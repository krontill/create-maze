---
name: debug
description: Systematically diagnose and fix unexpected behavior or failing tests. Use when something is broken and the cause is not immediately obvious. Reproduce first, fix last.
...
4. Verify or disprove the hypothesis by reading or running code — do not change behavior yet.
...
7. Apply the minimal fix. Confirm the reproduction case now passes.
